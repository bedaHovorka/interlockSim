...
// for linuxX64 needs a list of absolute directories to search. This task
		...
		doLast {
			...
			file.writeText(
				buildString {
					...
					appendLine("    \"${coreMainResources.absolutePath}\",")
					appendLine("    \"${coreTestResources.absolutePath}\",")
					appendLine("    \"${coreTestProjectResources.absolutePath}\",")
					appendLine(")")
				},
			)
		}
