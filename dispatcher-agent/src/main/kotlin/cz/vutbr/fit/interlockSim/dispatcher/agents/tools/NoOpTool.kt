 ...
 *
 * The optional `reason` parameter is accepted and ignored — it exists so the LLM can
 * explain its reasoning in a structured way without the explanation being treated as output.
 *
