 ...
 * [observation.AppliedOutcome.Approved] with `admitted = false` and a non-null
...
enum class ApplyFailureCode {
	 ...
	 *
	 * [ActionValidator] checks the cap against [observation.DispatcherObservation.activeCount],
	 ...
	 * the maximum.
	 *
	 * The [observation.AppliedOutcome.Approved] carrying this code is published through the
