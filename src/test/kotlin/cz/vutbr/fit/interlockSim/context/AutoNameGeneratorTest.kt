...
class AutoNameGeneratorTest : KoinTestBase() {
	...
	inner class NameGeneration {
		...
		fun `generates sequential names for same type`() {
			val name1 = AutoNameGenerator.generateName(RailSemaphore::class.java, context)
			val name2 = AutoNameGenerator.generateName(RailSemaphore::class.java, context)
			val name3 = AutoNameGenerator.generateName(RailSemaphore::class.java, context)
		...
		fun `independent counters for different types`() {
			val semaphore1 = AutoNameGenerator.generateName(RailSemaphore::class.java, context)
			val switch1 = AutoNameGenerator.generateName(RailSwitch::class.java, context)
			val semaphore2 = AutoNameGenerator.generateName(RailSemaphore::class.java, context)
			val switch2 = AutoNameGenerator.generateName(RailSwitch::class.java, context)
	...
	inner class Performance {
		...
		fun `rebuilds cache when context changes`() {
			...
			val name1 = AutoNameGenerator.generateName(RailSemaphore::class.java, context1)
			val name2 = AutoNameGenerator.generateName(RailSemaphore::class.java, context2)
	...
	inner class Reset {
		...
		fun `reset clears counters`() {
			...
			AutoNameGenerator.generateName(RailSemaphore::class.java, context) // S2
		...
		fun `reset clears cache`() {
			addSemaphore(5, 5, "S1")
			AutoNameGenerator.generateName(RailSemaphore::class.java, context) // Builds cache
